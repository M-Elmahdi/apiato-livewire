...
return [
  ...
  //  resource_path('views/livewire'),
    ...
    |--------------------------------------------------------------------------
    |
    | This value sets the path for Livewire component views.
    | Use in Render Method as    return view(config('livewire.view').'<Your Livewire Component');
    |
    */
    ...
    */
    ...
    'layout' => 'vendor@livewire::layouts.app',
